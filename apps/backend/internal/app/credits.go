...
// BudgetVerdict, BudgetState and CreditsExhaustedMessage live in
// budget_state.go: they cross the wire, and that file is what
// `packages/api-types` is generated from (T-02b).
